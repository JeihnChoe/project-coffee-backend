...
//
//        public MyProductDTO(Page<Product> products) {
//            this.products = new PageImpl<>(products.getContent().stream()
//                    .distinct().map(product -> new ProductDTO(product))
//                    .collect(Collectors.toList()), Pageable.unpaged(), products.getTotalElements());
//        }
//
//        @Getter
//        @Setter
